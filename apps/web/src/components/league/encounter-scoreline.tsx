    ...
    <Wedge as="header" className="p-5" tone="plate">
      <div className="flex flex-wrap items-center justify-between gap-x-8 gap-y-4">
        <div className="min-w-0">
          <p className="font-plate text-[0.75rem] font-semibold tracking-[0.14em] text-sisal-500 uppercase">
            <Link
          ...
          <h1 className="mt-1 font-numerals text-[2rem] leading-[0.85] font-bold tracking-[-0.015em] text-wedge-900">
      ...
      <div className="mt-5">
        <p className="font-plate text-[0.875rem] text-wedge-900">
      ...
      {encounter.result === null ? null : (
        <p className="mt-5 border-t border-sisal-400 pt-4 font-numerals text-[1.5rem] leading-tight font-bold text-wedge-900">
