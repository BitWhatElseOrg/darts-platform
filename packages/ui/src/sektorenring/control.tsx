...
const controlVariants = cva(
  [
    ...
    "font-plate text-body font-semibold uppercase tracking-[0.1em]",
  ...
  ],
  {
    variants: {
      ...
      density: {
        default: "min-h-11",
        tight: "min-h-11 px-3 text-caption tracking-[0.12em]",
      },
    },
  ...
  return (
    ...
    >
      ...
      {shortcut ? (
        <kbd
          className={cn(
            "ml-1 grid min-w-5 place-items-center border px-1 py-px font-numerals text-counter font-bold tabular",
            variant === "wire"
