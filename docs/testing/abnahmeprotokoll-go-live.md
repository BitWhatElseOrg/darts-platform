...
Stand: 18.09.2026. Release-Stand: `main` 051ddbf (Release-PR #49, `develop` →
...
- Block D: alle sechs Fälle grün. D3-1 ist sowohl auf Staging als auch in
  ...
  (mittel, serieller Login-Fall ohne 429) bleibt unbehoben und offen,
  unabhängig vom D3-1-Fix.
